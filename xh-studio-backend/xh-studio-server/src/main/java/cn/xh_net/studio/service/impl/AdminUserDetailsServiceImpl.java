...
@Service("userDetailsServiceForAdmin")
public class AdminUserDetailsServiceImpl implements UserDetailsService {
    ...
    public AdminUserDetailsServiceImpl(UserMapper userMapper, RoleMapper roleMapper) {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        queryWrapper.in("role_id", ROLE_ADMIN, ROLE_SUPER_ADMIN);
